    ...
    Alert.alert(
      ...
      [
        { text: 'Annuler', style: 'cancel' },
        {
          ...
          style: 'destructive',
          onPress: () => {
            mmkvStorage.clearAll(true);
            mmkvStorage.clearAll(false);
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <TextInput
              ...
              onChangeText={(t) =>
                setSettings((s) => ({ ...s, username: t.toUpperCase() }))
              }
              maxLength={6}
            />
          </View>
              ...
              {CUSTOM_COLORS.map((c) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.colorDot,
                    { backgroundColor: c },
                    settings.userArrowColor === c && styles.colorSelected,
                  ]}
        ...
        <View style={styles.section}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <TouchableOpacity
                onPress={() =>
                  setSettings((s) => ({
                    ...s,
                    gpsUpdateInterval: Math.max(1000, s.gpsUpdateInterval - 500),
                  }))
                }
              ...
              <TouchableOpacity
                onPress={() =>
                  setSettings((s) => ({
                    ...s,
                    gpsUpdateInterval: s.gpsUpdateInterval + 500,
                  }))
                }
                style={styles.miniBtn}
              >
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <TouchableOpacity
                onPress={() =>
                  setSettings((s) => ({
                    ...s,
                    orientationUpdateInterval: Math.max(
                      100,
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <TouchableOpacity
                onPress={() =>
                  setSettings((s) => ({
                    ...s,
                    maxTrailsPerUser: Math.max(50, (s.maxTrailsPerUser || 500) - 50),
                  }))
                }
                style={styles.miniBtn}
              >
              ...
              <TouchableOpacity
                onPress={() =>
                  setSettings((s) => ({
                    ...s,
                    maxTrailsPerUser: Math.min(1000, (s.maxTrailsPerUser || 500) + 50),
                  }))
                }
                style={styles.miniBtn}
              >
          ...
          <View style={styles.row}>
            ...
            <Switch
              ...
              onValueChange={(v) =>
                setSettings((s) => ({ ...s, disableBackgroundNotifications: v }))
              }
          ...
          <View style={styles.row}>
            <View>
              ...
              <Text style={styles.subLabel}>
                {settings.customMapUrl ? 'Fichier chargé' : 'Aucun fichier'}
              </Text>
            </View>
            <TouchableOpacity onPress={handlePickMapFile} style={styles.importBtn}>
              <Text style={{ color: 'white', fontSize: 10 }}>CHARGER MBTILES</Text>
            </TouchableOpacity>
          </View>
          <TextInput
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity onPress={clearStorage} style={styles.dangerBtn}>
          ...
          <Text style={styles.subLabel}>
            Utilise MMKV - Stockage chiffré AES-256
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            onPress={() => openDoc('PRIVACY.md')}
            style={styles.linkRow}
          >
            <Text style={styles.linkText}>Politique de Confidentialité</Text>
            <MaterialIcons name="open-in-new" size={20} color="#3b82f6" />
          </TouchableOpacity>
          <Text style={styles.versionText}>Version 4.2.0 - Native Performance</Text>
        </View>
